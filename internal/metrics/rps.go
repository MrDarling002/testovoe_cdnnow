...
// кольцевом буфере на 60 слотов.
//
// Модель конкурентности: каждый слот защищён собственным мьютексом.
// 60 независимых блокировок уменьшают конкуренцию. Критическая секция
// содержит только сравнение секунды, условный сброс и инкремент —
// без нативных вызовов и операций ввода-вывода.
